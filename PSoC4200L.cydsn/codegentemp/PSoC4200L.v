// ======================================================================
// PSoC4200L.v generated from TopDesign.cysch
// 05/07/2023 at 21:45
...
module top ;
    ...
    SPI_Master_v2_50_0 SPIM_EE (
        ...
        .ss(Net_3),
        .tx_interrupt(Net_9));
    defparam SPIM_EE.BidirectMode = 0;
    defparam SPIM_EE.HighSpeedMode = 0;
    defparam SPIM_EE.NumberOfDataBits = 8;
    defparam SPIM_EE.ShiftDir = 0;

    SPI_Slave_v2_70_1 SPIS_HOST (
        .clock(1'b0),
        .miso(Net_13),
        .miso_oe(Net_18),
        .mosi(Net_10),
        ...
        .ss(Net_12),
        .tx_interrupt(Net_15));
    defparam SPIS_HOST.NumberOfDataBits = 8;
    defparam SPIS_HOST.ShiftDir = 0;

	wire [0:0] tmpOE__EE_MISO_net;
	wire [0:0] tmpIO_0__EE_MISO_net;
	wire [0:0] tmpINTERRUPT_0__EE_MISO_net;
	electrical [0:0] tmpSIOVREF__EE_MISO_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		EE_MISO
		 (.oe(tmpOE__EE_MISO_net),
		  .y({1'b0}),
		  .fb({Net_56}),
		  .io({tmpIO_0__EE_MISO_net[0:0]}),
		  .siovref(tmpSIOVREF__EE_MISO_net),
		  .interrupt({tmpINTERRUPT_0__EE_MISO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EE_MISO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- Mux start --
    if (1)
    begin : mux_4
        reg  tmp__mux_4_reg;
        always @(Net_3 or Net_12 or Net_68)
        begin
            case (Net_68)
                1'b0 :  tmp__mux_4_reg = Net_3;
                1'b1 :  tmp__mux_4_reg = Net_12;
            endcase
        end
        assign Net_61 = tmp__mux_4_reg;
    end
    // -- Mux end --

    CyControlReg_v1_80 Control_SELECT_SPI (
        .clock(1'b0),
        .control_0(Net_68),
        .control_1(Net_30),
        .control_2(Net_66),
        ...
        .control_7(Net_72),
        .reset(1'b0));
    defparam Control_SELECT_SPI.Bit0Mode = 0;
    defparam Control_SELECT_SPI.Bit1Mode = 0;
    defparam Control_SELECT_SPI.Bit2Mode = 0;
    defparam Control_SELECT_SPI.Bit3Mode = 0;
    defparam Control_SELECT_SPI.Bit4Mode = 0;
    defparam Control_SELECT_SPI.Bit5Mode = 0;
    defparam Control_SELECT_SPI.Bit6Mode = 0;
    defparam Control_SELECT_SPI.Bit7Mode = 0;
    defparam Control_SELECT_SPI.BitValue = 0;
    defparam Control_SELECT_SPI.BusDisplay = 0;
    defparam Control_SELECT_SPI.ExtrReset = 0;
    defparam Control_SELECT_SPI.NumOutputs = 2;

    // -- Mux start --
    if (1)
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_10 or Net_24 or Net_68)
        begin
            case (Net_68)
                1'b0 :  tmp__mux_1_reg = Net_10;
                1'b1 :  tmp__mux_1_reg = Net_24;
            endcase
        end
        assign Net_27 = tmp__mux_1_reg;
    end
    // -- Mux end --
    ...
    begin : mux_2
        reg  tmp__mux_2_reg;
        always @(Net_56 or Net_13 or Net_30)
        begin
            case (Net_30)
                1'b0 :  tmp__mux_2_reg = Net_56;
                1'b1 :  tmp__mux_2_reg = Net_13;
            endcase
        end
        assign Net_31 = tmp__mux_2_reg;
    end
    // -- Mux end --

	wire [0:0] tmpOE__HOST_MOSI_net;
	wire [0:0] tmpIO_0__HOST_MOSI_net;
	wire [0:0] tmpINTERRUPT_0__HOST_MOSI_net;
	electrical [0:0] tmpSIOVREF__HOST_MOSI_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1f77d761-da2e-4cdb-a629-83a9fde1330b"),
		  ...
		  .input_buffer_sel(2'b00))
		HOST_MOSI
		 (.oe(tmpOE__HOST_MOSI_net),
		  .y({1'b0}),
		  .fb({Net_10}),
		  .io({tmpIO_0__HOST_MOSI_net[0:0]}),
		  .siovref(tmpSIOVREF__HOST_MOSI_net),
		  .interrupt({tmpINTERRUPT_0__HOST_MOSI_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HOST_MOSI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__EE_SS_net;
	wire [0:0] tmpFB_0__EE_SS_net;
	wire [0:0] tmpIO_0__EE_SS_net;
	wire [0:0] tmpINTERRUPT_0__EE_SS_net;
	electrical [0:0] tmpSIOVREF__EE_SS_net;
	...
	cy_psoc3_pins_v1_10
		...
		EE_SS
		 (.oe(tmpOE__EE_SS_net),
		  .y({Net_61}),
		  .fb({tmpFB_0__EE_SS_net[0:0]}),
		  .io({tmpIO_0__EE_SS_net[0:0]}),
		  .siovref(tmpSIOVREF__EE_SS_net),
		  .interrupt({tmpINTERRUPT_0__EE_SS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EE_SS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HOST_SS_net;
	wire [0:0] tmpIO_0__HOST_SS_net;
	wire [0:0] tmpINTERRUPT_0__HOST_SS_net;
	electrical [0:0] tmpSIOVREF__HOST_SS_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0ca698cf-ac5c-45cd-b1a6-2375a26665a0"),
		  ...
		  .input_buffer_sel(2'b00))
		HOST_SS
		 (.oe(tmpOE__HOST_SS_net),
		  .y({1'b0}),
		  .fb({Net_12}),
		  .io({tmpIO_0__HOST_SS_net[0:0]}),
		  .siovref(tmpSIOVREF__HOST_SS_net),
		  .interrupt({tmpINTERRUPT_0__HOST_SS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HOST_SS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__EE_MOSI_net;
	wire [0:0] tmpFB_0__EE_MOSI_net;
	wire [0:0] tmpIO_0__EE_MOSI_net;
	wire [0:0] tmpINTERRUPT_0__EE_MOSI_net;
	electrical [0:0] tmpSIOVREF__EE_MOSI_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		EE_MOSI
		 (.oe(tmpOE__EE_MOSI_net),
		  .y({Net_27}),
		  .fb({tmpFB_0__EE_MOSI_net[0:0]}),
		  .io({tmpIO_0__EE_MOSI_net[0:0]}),
		  .siovref(tmpSIOVREF__EE_MOSI_net),
		  .interrupt({tmpINTERRUPT_0__EE_MOSI_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EE_MOSI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- Mux start --
    if (1)
    begin : mux_3
        reg  tmp__mux_3_reg;
        always @(Net_11 or Net_54 or Net_68)
        begin
            case (Net_68)
                1'b0 :  tmp__mux_3_reg = Net_11;
                1'b1 :  tmp__mux_3_reg = Net_54;
            endcase
        end
        assign Net_52 = tmp__mux_3_reg;
    end
    // -- Mux end --

	wire [0:0] tmpOE__EE_CLK_net;
	wire [0:0] tmpFB_0__EE_CLK_net;
	wire [0:0] tmpIO_0__EE_CLK_net;
	wire [0:0] tmpINTERRUPT_0__EE_CLK_net;
	electrical [0:0] tmpSIOVREF__EE_CLK_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4426a7f2-722e-4c6f-937a-d81f31f027c7"),
		  ...
		  .input_buffer_sel(2'b00))
		EE_CLK
		 (.oe(tmpOE__EE_CLK_net),
		  .y({Net_52}),
		  .fb({tmpFB_0__EE_CLK_net[0:0]}),
		  .io({tmpIO_0__EE_CLK_net[0:0]}),
		  .siovref(tmpSIOVREF__EE_CLK_net),
		  .interrupt({tmpINTERRUPT_0__EE_CLK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EE_CLK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HOST_MISO_net;
	wire [0:0] tmpFB_0__HOST_MISO_net;
	wire [0:0] tmpIO_0__HOST_MISO_net;
	wire [0:0] tmpINTERRUPT_0__HOST_MISO_net;
	electrical [0:0] tmpSIOVREF__HOST_MISO_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c80a54e0-f7e8-433b-bb8b-c56164223ca1"),
		  ...
		  .input_buffer_sel(2'b00))
		HOST_MISO
		 (.oe(tmpOE__HOST_MISO_net),
		  .y({Net_31}),
		  .fb({tmpFB_0__HOST_MISO_net[0:0]}),
		  .io({tmpIO_0__HOST_MISO_net[0:0]}),
		  .siovref(tmpSIOVREF__HOST_MISO_net),
		  .interrupt({tmpINTERRUPT_0__HOST_MISO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HOST_MISO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HOST_CLK_net;
	wire [0:0] tmpIO_0__HOST_CLK_net;
	wire [0:0] tmpINTERRUPT_0__HOST_CLK_net;
	electrical [0:0] tmpSIOVREF__HOST_CLK_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8ab27e84-322a-48a8-8a28-9a28df518356"),
		  ...
		  .input_buffer_sel(2'b00))
		HOST_CLK
		 (.oe(tmpOE__HOST_CLK_net),
		  .y({1'b0}),
		  .fb({Net_11}),
		  .io({tmpIO_0__HOST_CLK_net[0:0]}),
		  .siovref(tmpSIOVREF__HOST_CLK_net),
		  .interrupt({tmpINTERRUPT_0__HOST_CLK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HOST_CLK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__EE_WP_net;
	wire [0:0] tmpFB_0__EE_WP_net;
	wire [0:0] tmpIO_0__EE_WP_net;
	wire [0:0] tmpINTERRUPT_0__EE_WP_net;
	electrical [0:0] tmpSIOVREF__EE_WP_net;
	...
	cy_psoc3_pins_v1_10
		...
		EE_WP
		 (.oe(tmpOE__EE_WP_net),
		  .y({Net_75}),
		  .fb({tmpFB_0__EE_WP_net[0:0]}),
		  .io({tmpIO_0__EE_WP_net[0:0]}),
		  .siovref(tmpSIOVREF__EE_WP_net),
		  .interrupt({tmpINTERRUPT_0__EE_WP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EE_WP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- Mux start --
    if (1)
    begin : mux_5
        reg  tmp__mux_5_reg;
        always @(Net_77 or Net_78 or Net_30)
        begin
            case (Net_30)
                1'b0 :  tmp__mux_5_reg = Net_77;
                1'b1 :  tmp__mux_5_reg = Net_78;
            endcase
        end
        assign Net_75 = tmp__mux_5_reg;
    end
    // -- Mux end --

	wire [0:0] tmpOE__HOST_WP_net;
	wire [0:0] tmpIO_0__HOST_WP_net;
	wire [0:0] tmpINTERRUPT_0__HOST_WP_net;
	electrical [0:0] tmpSIOVREF__HOST_WP_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("85ba8fb9-9f95-424a-ac7d-3dda17d885fb"),
		  ...
		  .input_buffer_sel(2'b00))
		HOST_WP
		 (.oe(tmpOE__HOST_WP_net),
		  .y({1'b0}),
		  .fb({Net_77}),
		  .io({tmpIO_0__HOST_WP_net[0:0]}),
		  .siovref(tmpSIOVREF__HOST_WP_net),
		  .interrupt({tmpINTERRUPT_0__HOST_WP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HOST_WP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_78 = 1'h0;

	wire [0:0] tmpOE__EE_HOLD_net;
	wire [0:0] tmpFB_0__EE_HOLD_net;
	wire [0:0] tmpIO_0__EE_HOLD_net;
	wire [0:0] tmpINTERRUPT_0__EE_HOLD_net;
	electrical [0:0] tmpSIOVREF__EE_HOLD_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c8ee9689-503e-43f3-a871-8f14fb01aa58"),
		  ...
		  .input_buffer_sel(2'b00))
		EE_HOLD
		 (.oe(tmpOE__EE_HOLD_net),
		  .y({Net_79}),
		  .fb({tmpFB_0__EE_HOLD_net[0:0]}),
		  .io({tmpIO_0__EE_HOLD_net[0:0]}),
		  .siovref(tmpSIOVREF__EE_HOLD_net),
		  .interrupt({tmpINTERRUPT_0__EE_HOLD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EE_HOLD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- Mux start --
    if (1)
    begin : mux_6
        reg  tmp__mux_6_reg;
        always @(Net_81 or Net_82 or Net_30)
        begin
            case (Net_30)
                1'b0 :  tmp__mux_6_reg = Net_81;
                1'b1 :  tmp__mux_6_reg = Net_82;
            endcase
        end
        assign Net_79 = tmp__mux_6_reg;
    end
    // -- Mux end --

	wire [0:0] tmpOE__HOST_HOLD_net;
	wire [0:0] tmpIO_0__HOST_HOLD_net;
	wire [0:0] tmpINTERRUPT_0__HOST_HOLD_net;
	electrical [0:0] tmpSIOVREF__HOST_HOLD_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("6a3b38a8-deef-4ecf-9ba7-b0c2bd1a3b66"),
		  ...
		  .input_buffer_sel(2'b00))
		HOST_HOLD
		 (.oe(tmpOE__HOST_HOLD_net),
		  .y({1'b0}),
		  .fb({Net_81}),
		  .io({tmpIO_0__HOST_HOLD_net[0:0]}),
		  .siovref(tmpSIOVREF__HOST_HOLD_net),
		  .interrupt({tmpINTERRUPT_0__HOST_HOLD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HOST_HOLD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
