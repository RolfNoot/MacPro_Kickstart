...
CFLAGS_CortexM0= -mcpu=cortex-m0 -mthumb -I. -IGenerated_Source/PSoC4 -Wa,-alh=$(OUT_DIR_CortexM0)/$(basename $(<F)).lst -g -D DEBUG -D CY_CORE_ID=0 -Wall -ffunction-sections -ffat-lto-objects -Og
...
LDFLAGS_CortexM0= -mcpu=cortex-m0 -mthumb -L Generated_Source/PSoC4 -Wl,-Map,$(OUT_DIR_CortexM0)/$(DESIGN).map -T Generated_Source/PSoC4/cm0gcc.ld -specs=nano.specs -Wl,--gc-sections -g -ffunction-sections -Og -ffat-lto-objects
